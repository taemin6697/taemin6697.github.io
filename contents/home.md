...
My research interests lie in **GPU/NPU heterogeneous systems**, **real-time systems**, **large language models**, and **human-computer interaction**. I am particularly interested in efficiently deploying and serving AI models on **edge and on-device systems**, enabling responsive and capable intelligence under practical constraints such as limited computation, memory, power, and latency.
